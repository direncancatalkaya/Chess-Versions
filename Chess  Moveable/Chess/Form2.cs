        ...
        private void button1_Click(object sender, EventArgs e)
        {
            switch (TasTipi)
            {
                ...
                case TasTipi.Fil:
                    ...
                    Form1.MevcutTaslar.Add(fil);
                    Form1.Squares[Y, X].Dolumu = true;
                    Form1.Squares[Y, X].Tas = fil;
                    Form1.Squares[Y,X].GetBackgroundİmage();
                    fil.Move(X, Y);
                ...
                case TasTipi.Vezir:
                    ...
                    Form1.MevcutTaslar.Add(vezir);
                    Form1.Squares[Y, X].Dolumu = true;
                    Form1.Squares[Y, X].Tas = vezir;
                    Form1.Squares[Y, X].GetBackgroundİmage();
                    vezir.Move(X,Y);
                    break;

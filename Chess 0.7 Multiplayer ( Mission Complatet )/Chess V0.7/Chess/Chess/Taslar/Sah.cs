...
namespace Chess
{
    public sealed class Sah : Tas, IRook
    {
        ...
        public bool isShortRookPossible()
        {
            if (İsBlack)
            {
                if (!İsSquareİnDanger(5, 7) && !İsSquareİnDanger(6, 7) && ChessBoard.Squares[7, 7].Tas.İsMoved == 0 && İsMoved == 0 && !İsKingDanger())
                {
                    return true;
                }
            ...
            {
                if (!İsSquareİnDanger(5, 0) && !İsSquareİnDanger(6, 0) && ChessBoard.Squares[0, 7].Tas.İsMoved == 0 && İsMoved == 0 && !İsKingDanger())
                {
                    return true;
                }
        ...
        public bool isLongRookPossible()
        {
            if (İsBlack)
            {
                if (!İsSquareİnDanger(2, 7) && !İsSquareİnDanger(3, 7) && ChessBoard.Squares[7, 0].Tas.İsMoved == 0 && İsMoved == 0 && !ChessBoard.Squares[7, 1].Dolumu && !İsKingDanger())
                {
                    return true;
                }
            ...
            {
                if (!İsSquareİnDanger(2, 0) && !İsSquareİnDanger(3, 0) && ChessBoard.Squares[0, 0].Tas.İsMoved == 0 && İsMoved == 0 && !ChessBoard.Squares[0, 1].Dolumu && !İsKingDanger())
                {
                    return true;
                }

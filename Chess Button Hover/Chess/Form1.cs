...
namespace Chess
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                for (int j = 0; j < 8; j++)
                {
                    ...
                    Squares[i, j].MouseEnter += new System.EventHandler(this.chessButton_MouseEnter);
                    Squares[i, j].MouseLeave += new System.EventHandler(this.chessButton_MouseLeave);
        ...
        public void EndGameCheck()
        {
            ...
            {
                if (VARIABLE.İsBlack && VARIABLE.TasTipi == TasTipi.Sah)
                {
                    black = true;
                }
            ...
            if (black && !white)
            {
                MessageBox.Show("Siyahlar Kazandı Tebrikler ..");
            }
            if (!black && white)
            {
                MessageBox.Show("Beyazlar Kazandı Tebrikler ..");
            }
        } // şu anki Logic de yok kullanmıyorum .. Oyun her türlü Şah mat la bitmek zorunda ..
        ...
        private void ChessButton_MouseDown(object sender, MouseEventArgs e)  //Tahtadaki Karelerin MouseDown eventi ..
        {
            ...
            if (castedbutton.Tas != null && !tasima)
            {
                ...
                {
                    if (VARIABLE.Attack && castedbutton.Tas.TasTipi == TasTipi.Piyon)
                    {
        ...
        private void chessButton_MouseEnter(object sender, EventArgs e)
        {
            ChessButton asd = (ChessButton)sender;
            if (asd.Tas != null)
            {
                asd.Size = new Size(80, 80);
                asd.Top -= 5;
                asd.Left -= 5;
                asd.BringToFront();
        ...
        private void chessButton_MouseLeave(object sender, EventArgs e)
        {
            ChessButton asd = (ChessButton)sender;
            if (asd.Tas != null)
            {

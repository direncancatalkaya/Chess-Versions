...
namespace Chess
{
    public class Sah : Tas, IRook
    {
        ...
        public bool isShortRookPossible()
        {
            if (İsBlack)
            {
                if (!İsSquareİnDanger(5, 7) && !İsSquareİnDanger(6, 7) && Form1.Squares[7, 7].Tas.İsMoved == 0 && İsMoved == 0)
                {
                    return true;
                }
            ...
            {
                if (!İsSquareİnDanger(5, 0) && !İsSquareİnDanger(6, 0) && Form1.Squares[0, 7].Tas.İsMoved == 0 && İsMoved == 0)
                {
                    return true;
                }
        ...
        public bool isLongRookPossible()
        {
            if (İsBlack)
            {
                if (!İsSquareİnDanger(2, 7) && !İsSquareİnDanger(3, 7) && Form1.Squares[7, 0].Tas.İsMoved == 0 && İsMoved == 0 && !Form1.Squares[7, 1].Dolumu)
                {
                    return true;
                }
            ...
            {
                if (!İsSquareİnDanger(2, 0) && !İsSquareİnDanger(3, 0) && Form1.Squares[0, 0].Tas.İsMoved == 0 && İsMoved == 0 && !Form1.Squares[0, 1].Dolumu)
                {
                    return true;
                }
        ...
        public void LetsShortRook()
        {
            ...
            {
                MoveNonCheck(6, 7);
                Form1.Squares[7, 7].Tas.MoveNonCheck(5, 7);
                Form1.TurnOfBlack = !Form1.TurnOfBlack;
            }
            else
            {
                MoveNonCheck(6, 0);
                Form1.Squares[0, 7].Tas.MoveNonCheck(5, 0);
                Form1.TurnOfBlack = !Form1.TurnOfBlack;
            }
        ...
        public void LetsLongRook()
        {
            ...
            {
                MoveNonCheck(2, 7);
                Form1.Squares[7, 0].Tas.MoveNonCheck(3, 7);
                Form1.TurnOfBlack = !Form1.TurnOfBlack;
            }
            else
            {
                MoveNonCheck(2, 0);
                Form1.Squares[0, 0].Tas.MoveNonCheck(3, 0);
                Form1.TurnOfBlack = !Form1.TurnOfBlack;
            }
